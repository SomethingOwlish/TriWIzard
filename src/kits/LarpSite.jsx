...
import { Anchor, Scroll, Compass, Shield } from './icons.jsx';

const rune = { fontFamily: 'var(--font-display)', color: 'var(--accent-text)', letterSpacing: '0.3em' };

function Header({ page, onNav, onEnterCabinet, theme, setTheme }) {
...
function Landing({ onNav, onTTRPG }) {
  return (
    <div>
      <Hero onNav={onNav} />
...
export default function LarpSite({ onEnterCabinet, onTTRPG, theme, setTheme }) {
