...
import { Users, Scroll as ScrollI, Edit, Plus } from './icons.jsx';
...
function TopBar({ master, setMaster, onTTRPG, theme, setTheme }) {
  return (
...
export default function LarpCabinet({ onTTRPG, onExit, theme, setTheme }) {
