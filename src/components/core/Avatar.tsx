...
const DIM: Record<string, number> = { xs: 24, sm: 32, md: 44, lg: 64, xl: 96 };
...
export function Avatar({ src, alt = '', initials, size = 'md', ring = false, status, square = false, style = {} }: AvatarProps) {
